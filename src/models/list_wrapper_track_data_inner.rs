...
pub struct ListWrapperTrackDataInner {
...
impl ListWrapperTrackDataInner {
    pub fn new(track_id: uuid::Uuid, tenant_id: uuid::Uuid, object_type: String, object_id: uuid::Uuid, modification_type: models::ModificationType, part: Vec<String>, actor_id: uuid::Uuid, last_change: String) -> ListWrapperTrackDataInner {
